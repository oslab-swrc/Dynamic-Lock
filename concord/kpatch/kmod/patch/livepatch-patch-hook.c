...
// Profile
void *bpf_prog_custom_lock_acquire = NULL;
void *bpf_prog_custom_lock_contended = NULL;
void *bpf_prog_custom_lock_acquired = NULL;
void *bpf_prog_custom_lock_release = NULL;

// Shfllock
void *bpf_prog_custom_cmp_func = NULL;
void *bpf_prog_custom_skip_func = NULL;
void *bpf_prog_custom_break_func = NULL;

// Experimental
void *bpf_prog_custom_lock_bypass_acquire = NULL;
void *bpf_prog_custom_lock_bypass_release = NULL;

// Profile
EXPORT_SYMBOL(bpf_prog_custom_lock_acquire);
EXPORT_SYMBOL(bpf_prog_custom_lock_contended);
EXPORT_SYMBOL(bpf_prog_custom_lock_acquired);
EXPORT_SYMBOL(bpf_prog_custom_lock_release);

// Shfllock
EXPORT_SYMBOL(bpf_prog_custom_cmp_func);
EXPORT_SYMBOL(bpf_prog_custom_skip_func);
EXPORT_SYMBOL(bpf_prog_custom_break_func);

// Experimental
EXPORT_SYMBOL(bpf_prog_custom_lock_bypass_acquire);
EXPORT_SYMBOL(bpf_prog_custom_lock_bypass_release);
